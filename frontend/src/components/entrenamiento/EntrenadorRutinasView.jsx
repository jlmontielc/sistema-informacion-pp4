...
export function EntrenadorRutinasView() {
          ...
          {plantillas.length === 0 ? (
            <Card>
              <EmptyState
                ...
                description="Crea tu primera plantilla para organizar los ejercicios por dias."
                ...
                <Card key={p.id}>
                  <div style={{ padding: 'var(--space-5)' }}>
                    ...
                    <div className="rutina-resumen-stats">
                      ...
                      <div className="rutina-resumen-stat">
                        <div className="rutina-resumen-stat-value">{(p.ejercicios || []).length}</div>
          ...
          {rutinas.length === 0 ? (
            <Card>
              <EmptyState
                ...
                description="Selecciona una plantilla y asignala a un cliente."
              />
            </Card>
          ) : (
            <div className="rutinas-grid">
                ...
                <Card key={r.id}>
                  <div style={{ padding: 'var(--space-5)' }}>
                    ...
                    <div className="rutina-resumen-stats">
                      ...
                      <div className="rutina-resumen-stat">
                        <div className="rutina-resumen-stat-value">{(r.ejercicios || []).length}</div>
                        <div className="rutina-resumen-stat-label">ejercicios</div>
                      </div>
                    </div>
                    {r.fechaInicio && (
